...
def main():
    ...
    parser.add_argument('--probe_epochs', type=int, help='epochs to train the probe model for', default = 200)
    parser.add_argument('--epochs', type=int, help='epochs to train for', default = 200)
    parser.add_argument('--checkpoint_interval', type=int, help='checkpoint interval for VoG metric', default = 5)
